# Generated by Django 4.0.5 on 2022-12-21 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_content', models.TextField(max_length=350, verbose_name='More Information')),
                ...
                ('ft_likes', models.ManyToManyField(blank=True, related_name='feature_likes', to='whatsonzambia.ipmodel')),
                ('ft_views', models.ManyToManyField(blank=True, related_name='feature_views', to='whatsonzambia.ipmodel')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('content', models.TextField(max_length=350, verbose_name='More Information')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('likes', models.ManyToManyField(blank=True, related_name='post_likes', to='whatsonzambia.ipmodel')),
                ('views', models.ManyToManyField(blank=True, related_name='post_views', to='whatsonzambia.ipmodel')),
            ],
        ),
    ]
